/* Scen 2 – Vad som testades. Tider: REEL.T.testet. Se STORYBOARD.md. */
(function () {
  const R = REEL, C = R.C, F = R.F, E = R.E, SAFE = R.SAFE, T = R.T.testet;
  ...
  R.scene({
    ...
    draw(ctx, s, t) {
      ...
      R.label(ctx, "scen 2 · Vad som testades", SAFE.cx, SAFE.cy - 60, { alpha: a });
