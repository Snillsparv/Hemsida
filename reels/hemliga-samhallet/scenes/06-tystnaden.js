/* Scen 6 – Tystnaden. Tider: REEL.T.tystnaden. Se STORYBOARD.md. */
(function () {
  const R = REEL, C = R.C, F = R.F, E = R.E, SAFE = R.SAFE, T = R.T.tystnaden;
  ...
  R.scene({
    ...
    draw(ctx, s, t) {
      ...
      R.label(ctx, "scen 6 · Tystnaden", SAFE.cx, SAFE.cy - 60, { alpha: a });
