/* Scen 4 – Vändningen. Tider: REEL.T.vandningen. Se STORYBOARD.md. */
(function () {
  const R = REEL, C = R.C, F = R.F, E = R.E, SAFE = R.SAFE, T = R.T.vandningen;
  ...
  R.scene({
    ...
    draw(ctx, s, t) {
      ...
      R.label(ctx, "scen 4 · Vändningen", SAFE.cx, SAFE.cy - 60, { alpha: a });
